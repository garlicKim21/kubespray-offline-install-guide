...
> **중요:** Kubespray 버전마다 의존성이 다르므로, 새 버전에 맞는 가상환경을 설정해야 합니다.
...
> **주의:** Ansible의 `--check` 모드는 dry-run으로 동작하지만, **이전 태스크의 결과에 의존하는 후속 태스크**에서 실패할 수 있습니다.
...
> **주의:** Kubespray는 공식적인 롤백 기능을 제공하지 않습니다.
